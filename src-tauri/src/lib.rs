...
mod screenshot {
    pub mod commands {
        ...
        pub async fn screenshot_begin(
            _app: AppHandle,
            _request: ScreenshotBeginRequest,
        ) -> Result<(), String> {
            Err("SCREEN_CAPTURE_NOT_INCLUDED: \
                 this build does not include the screen-capture feature"
                .to_string())
        }

        #[tauri::command]
        pub async fn screenshot_overlay_init(_window_label: String) -> Result<(), String> {
            Err("SCREEN_CAPTURE_NOT_INCLUDED: \
                 this build does not include the screen-capture feature"
                .to_string())
        }
        ...
        #[tauri::command]
        pub async fn screenshot_commit(_app: AppHandle, _request: ()) -> Result<(), String> {
            Err("SCREEN_CAPTURE_NOT_INCLUDED: \
                 this build does not include the screen-capture feature"
                .to_string())
        }
