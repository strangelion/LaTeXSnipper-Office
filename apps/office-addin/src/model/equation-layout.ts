...
export const EQUATION_LAYOUT_PROFILES: readonly EquationLayoutProfile[] = [
  ...
  { ...DEFAULT_EQUATION_LAYOUT_PROFILE, id: "chapter-dot", numberingScheme: "chapter-dot", separator: ".", restartPerChapter: true, chapterStyle: "Heading 1", chapterLevel: 1 },
  { ...DEFAULT_EQUATION_LAYOUT_PROFILE, id: "chapter-hyphen", numberingScheme: "chapter-hyphen", separator: "-", restartPerChapter: true, chapterStyle: "Heading 1", chapterLevel: 1 },
];

export function getEquationLayoutProfile(id?: string): EquationLayoutProfile {
  return EQUATION_LAYOUT_PROFILES.find((profile) => profile.id === id) ?? DEFAULT_EQUATION_LAYOUT_PROFILE;
}
