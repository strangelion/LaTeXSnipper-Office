...
EXTERN_C const IID IID_ILatexSnipperFormula;
    ...
    public:
        ...
        virtual /* [id] */ HRESULT STDMETHODCALLTYPE GetExtentJson(
            /* [retval][out] */ BSTR *extentJson) = 0;

        virtual /* [id] */ HRESULT STDMETHODCALLTYPE CompleteInsertion( void) = 0;

        virtual /* [id] */ HRESULT STDMETHODCALLTYPE SetDisplayExtentHimetric(
            /* [in] */ LONG cx,
            /* [in] */ LONG cy) = 0;
    ...
    typedef struct ILatexSnipperFormulaVtbl
    {
        ...
        DECLSPEC_XFGVIRT(ILatexSnipperFormula, GetExtentJson)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *GetExtentJson )(
            ILatexSnipperFormula * This,
            /* [retval][out] */ BSTR *extentJson);

        DECLSPEC_XFGVIRT(ILatexSnipperFormula, CompleteInsertion)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *CompleteInsertion )(
            ILatexSnipperFormula * This);

        DECLSPEC_XFGVIRT(ILatexSnipperFormula, SetDisplayExtentHimetric)
        /* [id] */ HRESULT ( STDMETHODCALLTYPE *SetDisplayExtentHimetric )(
            ILatexSnipperFormula * This,
            /* [in] */ LONG cx,
            /* [in] */ LONG cy);
...
#define ILatexSnipperFormula_GetExtentJson(This,extentJson)	\
    ( (This)->lpVtbl -> GetExtentJson(This,extentJson) )

#define ILatexSnipperFormula_CompleteInsertion(This)	\
    ( (This)->lpVtbl -> CompleteInsertion(This) )
